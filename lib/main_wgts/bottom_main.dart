 ...
 final _pages=[
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(backgroundColor: Color.fromARGB(225, 27, 57, 61), selectedItemColor: Color.fromARGB(255, 154, 0, 0),unselectedItemColor: Colors.black,currentIndex: _currentSelectIndex,onTap:(newindex){
        setState(() {
